    ...
    public class PanelGame : WaterGame
    {
        ...
        public PanelGame() : base()
        {
            ...
            for (int i = 0; i <= 4; i++)
            {
                ...
                var zcontainer = new GridContainer();
                zcontainer.RelativePosition = new(0, 0, 100, 100);
                zcontainer.Layout = Layout.Fill;
                xcontainer.AddChild(zcontainer);
                zcontainer.Children = new IContainer[5, 5];
                for (int s = 0; s <= 4; s++)
                {
                    for (int y = 0; y <= 4; y++)
                    {
                        ...
                        zcontainer.AddChild(obj4);
                        zcontainer.Children[s, y] = obj4;
            ...
            text4.HorizontalTextAlignment = HorizontalTextAlignment.Center;
            text4.VerticalTextAlignment = VerticalTextAlignment.Bottom;
